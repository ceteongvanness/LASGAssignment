...
namespace Ass5.Workflows {
    ...
    public partial class TaskWorkflowService : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TaskWorkflowService).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TaskWorkflowService));
        ...
        private string FindResource() {
            string[] resources = typeof(TaskWorkflowService).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TaskWorkflowService.g.xaml") || resource.Equals("TaskWorkflowService.g.xaml"))) {
                    return resource;
                }
            }
